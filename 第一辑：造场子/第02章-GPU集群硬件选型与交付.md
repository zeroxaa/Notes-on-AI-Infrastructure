...
很多人第一反应是：买最贵的。既然 H200 是训练卡里的旗舰，那就全上 H200。这个思路在某些场景下成立，但在更多场景下会浪费钱，甚至影响业务。
...
- 训练卡与推理卡的适用场景划分，是基于产品规格和行业常见实践的归纳
- 混合部署策略（训练独占、推理 MIG、开发测试 Time Slicing）是基于 GPU 调度与资源管理文档的总结
- 昇腾 910B 与 NVIDIA 硬件架构差异：NVIDIA 以 SM/CUDA/Tensor Core 为主，昇腾以 AI Core + 达芬奇 Cube/Vector/Scalar 为主，来自公开技术资料
- 昇腾 910B 与 NVIDIA 物理隔离部署、MFU 低 5-10 个百分点、故障定位耗时长：来自 `yidian/AI_Platform_Selfbuilt_Report.md`
