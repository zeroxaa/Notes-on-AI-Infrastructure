...
- 智算网络选型的 IB vs RoCEv2 建议，是基于产品特性和行业常见实践的归纳
- Fat-Tree 与轨道优化拓扑的适用场景，是基于网络架构文档的总结
- iWARP 基于 TCP 实现 RDMA、无需 PFC/ECN，来自公开网络协议资料
- iWARP 在 AI 训练集群中应用较少，是基于公开技术资料的归纳
- 网络可观测性指标分类，是基于 ROCEv2 文档和运维实践整理的
