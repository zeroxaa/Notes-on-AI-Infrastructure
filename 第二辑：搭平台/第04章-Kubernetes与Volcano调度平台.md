...
![图01-原生调度器死锁与GangScheduling](图片/第04章/图01-原生调度器死锁与GangScheduling.png)
...
![图02-Volcano组件架构](图片/第04章/图02-Volcano组件架构.png)
...
- 队列划分策略是基于多租户训练集群的常见实践
- Kubernetes 运行训练任务的挑战总结，来自部署实践
- NCCL 环境变量具体值需根据节点硬件调整
