...
- 参数服务器与 AllReduce 的对比结论，基于 Ring AllReduce 无中心节点、传输量可控的特性推导
- 并行策略与通信原语的对应关系，基于分布式训练常见实践总结
- NCCL timeout 排查顺序，基于运维排障常见思路
- 8000 卡场景 QP 数量估算（每个远端约 4 个 QP）为工程经验估算
- HCCL 与 NCCL 的差异对比，基于昇腾与 NVIDIA 生态差异总结
