...
![图01-AIInfra工程师能力模型](图片/第10章/图01-AIInfra工程师能力模型.png)
...
![图02-AIInfra全链路角色](图片/第10章/图02-AIInfra全链路角色.png)
...
- 能力模型和成长路径，是基于行业常见要求总结
- 技术广度与深度平衡建议，属于通用职业发展建议
- "日常一天"和成长案例为合理示例，非特定个人经历
